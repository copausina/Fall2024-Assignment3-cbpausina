...
namespace Fall2024_Assignment3_cbpausina.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TweetsJson = table.Column<string>(type: "TEXT", nullable: false),
                    TweetSentiment = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewSentiment = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
